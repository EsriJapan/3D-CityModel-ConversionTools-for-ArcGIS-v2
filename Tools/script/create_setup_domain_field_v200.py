...
setTnmDomainList = {
           "gml_name": "WaterBody_Name",
           "uro_WaterBodyTsunamiFloodingRiskAttribute_description": "WaterBodyTsunamiRiskAttribute_description",
           "uro_WaterBodyTsunamiFloodingRiskAttribute_rankOrg": "WaterBodyTsunamiRiskAttribute_rankOrg"
           }

# ドメイン設定対象のフィーチャ クラス
htdTargetLayers = ["lod1_WaterBody_fld"]
# ドメイン作成用リスト（key:ドメイン名, description:ドメイン対象 xml ファイル）
htdDomainList = {
           "WaterBody_Name": "WaterBody_name.xml",
           "WaterBodyRiverFloodingRiskAttribute_description": "WaterBodyRiverFloodingRiskAttribute_description.xml",
...
setHtdDomainList = {
           "gml_name": "WaterBody_Name",
           "uro_WaterBodyHighTideFloodingRiskAttribute_description": "WaterBodyHighTideRiskAttribute_description",
           "uro_WaterBodyHighTideFloodingRiskAttribute_rankOrg": "WaterBodyHighTideRiskAttribute_rankOrg"
           }

# ドメイン設定対象のフィーチャ クラス
ifldTargetLayers = ["lod1_WaterBody_fld"]
# ドメイン作成用リスト（key:ドメイン名, description:ドメイン対象 xml ファイル）
ifldDomainList = {
           "WaterBody_Name": "WaterBody_name.xml",
           "WaterBodyInlandFloodingRiskAttribute_description": "WaterBodyInlandFloodingRiskAttribute_description.xml",
...
setIfldDomainList = {
           "gml_name": "WaterBody_Name",
           "uro_WaterBodyInlandFloodingFloodingRiskAttribute_description": "WaterBodyInlandFloodingRiskAttribute_description",
           "uro_WaterBodyInlandFloodingFloodingRiskAttribute_rankOrg": "WaterBodyInlandFloodingRiskAttribute_rankOrg"
           }
...
def createDomain(folderPath, domainName, domainList):
    ...
    try:
        if os.path.isfile(filePath):
            ...
            settedDomainNameList[domainName] = ""
        else:
