# coding:utf-8
"""
Name        :field_calculate_buildingName_v200.py
Purpose     :3D都市モデルの建物（Building）で、gml:name 属性の型は、gml:CodeType [0..1]となっています。
             ...
             v100 → v200 の更新内容
               ...
               assign_extendedAttributes_v113.py はそのまま利用
             
Arguments   :引数1=Building_name.xml、引数2=ワークスペース
Author      :
Copyright   :
Created     :2023/06/30
Last Updated:
...
FCNAMES = ["lod0_Building", "lod1_Building", "lod2_Building", "lod3_Building", "lod1_BuildingPart", "lod2_BuildingPart", "lod3_BuildingPart"]
